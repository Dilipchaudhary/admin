...
(function($) {
    ...
    var Transfer = function(element, options) {
        ...
        // group tab text
        this.groupTabNameText = "List";
        // right tab text
        this.rightTabNameText = "Selected";
    ...
    Transfer.prototype.generate_transfer = function() {
        var html =
            ...
            + '<div class="btn-select-arrow" id="add_selected_' + this.id + '"><i class="fa fa-chevron-right"></i></div>'
            + '<div class="btn-select-arrow" id="delete_selected_' + this.id + '"><i class="fa fa-chevron-left"></i></div>'
            + '</div>'
